...
namespace HospitalDataLayer
{
    public class clsPatientsData
    {
                                                   ...
                                                   DateTime LastVisitDate,ref bool PatientStatus,ref string Notes)
        {
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    ...
                    BloodType = Convert.ToInt32((Byte)reader["BloodType"]);
        ...
        public static bool GetPatientInfoByNationalNO(string NationalNO,ref int PatientID,ref int PersonID, ref int BloodType, ref string Allergies, ref int EmergencyContactID,
                                                   DateTime LastVisitDate,ref bool PatientStatus, ref string Notes)
        {
            bool IsFound = false;
            SqlConnection connection = new SqlConnection(clsDataAccessSettings.ConnectionString);
            string query = @"
                            Select Patients.PatientID,Patients.PersonID,Patients.BloodType,
                            Patients.Allergies,Patients.EmergencyContactID,Patients.LastVisitDate,Patients.PatientStatus,
                            Patients.Notes
                            From Patients 
                            Inner Join 
                            People
                            On People.PersonID = Patients.PersonID
            ...
            try
            {
                ...
                if (reader.Read())
                {
                    ...
                    PatientID = (int)reader["PatientID"];
                    PersonID = (int)reader["PersonID"];
                    BloodType = Convert.ToInt32(reader["BloodType"]);
                    LastVisitDate = (DateTime)reader["LastVisitDate"];
                    PatientStatus = (bool)reader["PatientStatus"];
        ...
        public static bool GetEmergemcyContactInfo(int EmergemcyContactID,ref string ContactName,ref string ContactFirstPhoneNO,ref string ContactSecondPhoneNO,ref string RelationshipWithEmergencyContact)
        {
            ...
            SqlConnection connection = new SqlConnection(clsDataAccessSettings.ConnectionString);
            string query = "Select * From PatientEmergencyContacts Where EmergencyContactID = @EmergemcyContactID";
            SqlCommand command = new SqlCommand(query, connection);
        ...
        public static DataTable GetTop3PatientsThereNameStartWith(string PatientName)
        {
            DataTable dt = new DataTable();
            ...
            string query = @"
                            SELECT  Top 3      Patients.PatientID, Patients.PersonID, Patients.BloodType,
                            Patients.Allergies, Patients.EmergencyContactID, Patients.LastVisitDate,
                            Patients.PatientStatus, Patients.Notes,
                            ...
                            FROM            Patients INNER JOIN
						                            ...
						                            Where People.FirstName Like @PatientName ";
